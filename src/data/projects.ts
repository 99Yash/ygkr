...
export const projects = [
  ...
  },
  {
    name: "Trinsta",
    description:
      "An Innovative Instagram Iteration Developed with the t3-Stack. Harnessing the Power of tRPC, Shadcn/UI, React Server Components, the Pioneering uploadThing API for Seamless File Integration, Prisma, Zod, and React Hook Forms.",
